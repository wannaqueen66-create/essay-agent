...
`essay-agent` 是一个面向建筑学、体育空间、VR 环境、空间行为、行为轨迹与疗愈空间研究场景的多源文献自动检索与 AI 结构化分析工具。
...
- VR / HCI / 感知
- 行为轨迹 / 时空行为 / 城市空间
- 疗愈空间 / 恢复性环境 / 健康促进设计（包括 HERD Journal、Health and Place、Landscape and Urban Planning）
